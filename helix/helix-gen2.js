...
*/
    ...
    const barGrid = [[0, 0, 0], [0, 1, 10], [2, 2, 20]];

    const bars = cut.solidFromSlices({
		numslices: barGrid.length,
		callback: function(t, slice) {
		    const e = barGrid[slice];
			return this.translate([e[0], 0, e[1]]).rotateY(e[2]);
		}
	});
...
const main = (props) => {
	...
	.union(core1.union(cage1).rotateX(180).rotateY(180).translate([13, 5, 0]))
};
// END
